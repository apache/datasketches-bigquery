...
CREATE OR REPLACE FUNCTION `$BQ_PROJECT.$BQ_DATASET`.cpc_sketch_get_estimate_and_bounds(base64 BYTES, num_std_devs INT, seed INT64) RETURNS ARRAY<FLOAT64> LANGUAGE js
